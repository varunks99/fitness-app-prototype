...
const FAQ = () => {
    return (
        <List.AccordionGroup>
            <List.Accordion title="What information does GoFit collect about me?" id="1" titleStyle={{ color: "#8454ac" }} style={{ backgroundColor: "#eee", marginBottom: 3 }}>
                <List.AccordionGroup>
                    ...
                    <List.Accordion title="Contacts Information" id="1.4">
                        <List.Section>
                            <List.Item descriptionNumberOfLines={10} description="If you choose to share your contacts with GoFit, THE APP will store and access your contacts' information securely to identify connections and help you connect with them." />
                        </List.Section>
                    </List.Accordion>
